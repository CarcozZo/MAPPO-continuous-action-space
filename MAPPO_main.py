...
from SAGIN_env import GroundDevices, UAVNetwork, CircularDict, SatelliteNetwork, DataOffloadingOptimizer
import pandas as pd
import gym
...
class Runner_MAPPO_MPE:
    def __init__(self, args, env_name, number, seed):
        ...
        # Create env
        optimizer=None
        self.env = gym.make('SAGIN-v1', optimizer=optimizer)
        ...
        self.args.action_dim_n = [self.env.action_space.shape[0] for i in range(self.args.N)]  # actions dimensions of N agents
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("Hyperparameters Setting for MAPPO in SAGIN environment")
    ...
    runner = Runner_MAPPO_MPE(args, env_name="env_MAPPO", number=1, seed=0)
    runner.run()
